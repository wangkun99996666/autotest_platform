...
class test_minder_manage:
    ...
    def new_minder(self, module, name, description, content='{}'):
        ...
        sql = string.Template(
            'insert into test_minder (module,name,description,content,batchId) values ("$module","$name","$description","$content","$batchId");')
    ...
    def copy_test_minder(self, id):
        ...
        if len(searchresult):
            ...
            result = self.new_minder(name=searchresult['name'], module=searchresult['module'],
                                     description=searchresult['description'], content=searchresult['content'])
        return result
    ...
    def show_test_minders(self, conditionList, valueList, rows):
        ...
        sql = 'select ' + search_value + ' from test_minder where status = 1 ' + str(
